...
let
  # Caelestia scripts derivation disabled
  ...
  #   };
  #   # error: hash mismatch in fixed-output derivation '/nix/store/nd1a0kj261ksm5wzr37hjy7c5c6bnvg3-source.drv':
  #   #          specified: sha256-srhGlLdqWgWGMnHoqKZSRLrBbH8/9rmIuns01B4s36Q=
  #   #             got:    sha256-exGj4YXYPAk0gzs7Wk7DMpSZAhlreGpdfJvPU4djRIw=
...
in
{
  options.programs.quickshell = {
    ...
    # caelestia-scripts option disabled
